...
An e-commerce website clone inspired by Amazon, built with HTML, CSS, and JavaScript. This project demonstrates modern web development techniques for creating an online shopping platform with interactive features.The page is created for big screens i.e, laptops, PCs only.

## Screenshots

![Homepage](images/scr.png)
